...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: NullLogger</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: NullLogger</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-null_logger.html">null_logger</a>~</span>NullLogger</h2>
...
<article>
    ...
    <h4 class="name" id="NullLogger"><span class="type-signature"></span>new NullLogger<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="null_logger.js.html">null_logger.js</a>, <a href="null_logger.js.html#line13">line 13</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="log"><span class="type-signature"></span>log<span class="signature">(message)</span><span class="type-signature"> &rarr; {null}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="null_logger.js.html">null_logger.js</a>, <a href="null_logger.js.html#line24">line 24</a>
    </li></ul></dd>
